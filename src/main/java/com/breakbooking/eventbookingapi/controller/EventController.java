...
//	@GetMapping("/{eid}/bookings")
//	@ApiOperation(value = "Finds all Event Bookings of an Event")
//	public List<Booking> getBookingsOfEvent(@PathVariable("eid") String eid ){
//		return eventService.getBookingsOfEvent(eid);
//	}

//	@PutMapping("/book")
//	public Map<String,Boolean> enrolledUsers(@RequestBody String eventId,
//											 @RequestBody String bookingId){
//
//		return eventService.enrolledUsers(eventId,bookingId);
//	}


//	@GetMapping("/booking/{bookingId}")
//	@ApiOperation(value = "Finds all Event Bookings of User")
//	public List<Event> findBookedEvents(@PathVariable("bookingId") String bookingId ){
//		return eventService.findBookedEvents(bookingId);
//	}
